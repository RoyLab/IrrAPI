...
#ifndef __C_PARTICLE_SPH_AFFECTOR_H_INCLUDED__
#define __C_PARTICLE_SPH_AFFECTOR_H_INCLUDED__

#include "IParticleSPHAffector.h"
...
class CParticleSPHAffector : public IParticleSPHAffector
{
public:

	CParticleSPHAffector(
